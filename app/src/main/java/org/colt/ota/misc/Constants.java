 ...
 */
package org.colt.ota.misc;

import android.app.AlarmManager;

public class Constants {
    // Download related
    public static final String UPDATES_FOLDER = "ColtOS-Updates";
    public static final String DOWNLOAD_ID = "download_id";
    public static final String DOWNLOAD_NAME = "download_name";
    public static final String DOWNLOAD_TMP_EXT = ".tmp";
    public static final String DOWNLOAD_CHANNEL_ID = "org.colt.ota.DOWNLOAD_CHANNEL";
    public static final String DOWNLOADING_CHANNEL_ID = "org.colt.ota.DOWNLOADING_CHANNEL";
    // Preferences

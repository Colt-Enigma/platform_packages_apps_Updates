...
public final class Constants {
    ...
    static final String PROP_DEVICE = "ro.colt.device";
    static final String PROP_BUILD_VERSION = "ro.colt.main.version";
    static final String PROP_VERSION_CODE = "ro.colt.main.version";
    static final String OTA_URL = "https://raw.githubusercontent.com/ColtOS-Devices/official_devices/c11/builds/%s.json";
    static final String DOWNLOAD_WEBPAGE_URL = "https://raw.githubusercontent.com/ColtOS-Devices/official_devices/c11/changelogs/%s/%s.txt";
    public static final String DOWNLOAD_PATH = "/data/system_updates/";
    static final String EXPORT_PATH = "ColtOS-Updates/";
